        ...
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    ...
                    ?>
                        <tr>
                            <th></th><th>Total [HKD]</th><th> <?php echo $sum?></th><th><a href="cart_modify.php?id=<?php echo $user_id?>" class="btn btn-primary">Amount Modify</a></th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
