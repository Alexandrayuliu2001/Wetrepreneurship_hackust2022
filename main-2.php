...
<html>
	...
	<body onload="addLinkForImage()" style="text-align: center; background-image:url(/4210/picture/bg1.jpg)";>
		<script src="/4210/4210/javascript/javascript1.js"></script>
		<script>
				...
				<ul >
                    <li>
                        <div  id="category" style="position: fixed ; left: 0px; top:100px">
							<ul class="category">
								<li><img src="/4210/picture/bg2.jpg" width="140" height="70"></li>
								<li><a class="category" href="main.php"><hr>HOME<hr></a></li>
